  ...
  class << self
    ...
    def system_prompt
      "あなたは経験豊富な卓球コーチです。\n" \
        ...
        "各ラリーは「誰が得点したか（自分 or 相手）」と「そのラリーを決めた技術名」を記録しています。\n" \
        "「自分得点」はその技術で自分が点を取った回数、「相手得点」は相手がその技術で点を取った回数です。\n" \
        "「相手の得点技術」は相手が実際に使って得点した技術であり、自分の失点技術とは異なります。\n" \
    ...
    def advice_format_instruction
      <<~TEXT.chomp
        ...
        2.【レシーブ戦術の改善】アドバイス文
        3.【得意技術の活用戦略】アドバイス文
        4.【弱点・課題技術の改善方法】アドバイス文（相手にとくに得点された技術を弱点・課題と見なして分析すること）

module ApplicationHelper
  ...
  BATTING_STYLE_ABBR_MAP = {
    ...
    'fore_push' => { abbr: 'FP',  label: 'フォアツッツキ' },
    'back_push' => { abbr: 'BP',  label: 'バックツッツキ' },
    ...
    'fore_block' => { abbr: 'FBk', label: 'フォアブロック' },
    'back_block' => { abbr: 'BBk', label: 'バックブロック' },
